...
Finally, we apply \cref{alg:constrained simple,alg:constrained hard} to sample from the \ac{kde} while the scenario parameters are subjected to linear constraints.
...
We work with a data set obtained by a vehicle equipped with sensors while driving a predefined route in The Netherlands. 
