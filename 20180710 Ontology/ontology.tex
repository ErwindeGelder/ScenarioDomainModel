...
According to Gruber \cite{gruber1993ontology}, ``an ontology is an explicit specification of a conceptualization''. Here, a conceptualization refers to ``an abstract, simplified view of the world that we wish to represent for some puppose'' \cite{gruber1993ontology}.

For the visualization of the classes of the ontology, a similar approach as given in \cite{vanDamPhDThesis2009} is used.
...
\begin{figure}[h]
	...
	\class{ScenarioClass}{%
		...
		tagsCombinations,Instances,TagCombination;
		scenarios,Instances,Scenario
	}
\end{figure}

\class{TagCombination}{tags,Instances,Tag}
...
\class{StaticEnvironment}{staticEnvironmentProperties,Instances,StaticEnvironmentProperty}

\class{DynamicEnvironment}{dynamicElements,Instances,DynamicElement}
