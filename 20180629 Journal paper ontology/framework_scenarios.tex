...
%\thispagestyle{empty}
%\pagestyle{empty}
\title{\cstartb Towards an Ontology of Scenarios for the Assessment of Automated Vehicles: An Object-Oriented Framework \cendb}
...
\author[4]{Steven Kraines}
\author[5,6]{Jeroen Ploeg}
