...
\author{Erwin de Gelder$^{1,2*}$, Jan-Pieter Paardekooper$^{1,3}$, Arash Khabbaz Saberi$^{1}$, Hala Elrofai$^{1}$, Olaf Op den Camp$^{1}$, \\ Jeroen Ploeg$^{4}$, Ludwig Friedmann$^{5}$, Bart De Schutter$^{2}$%
...
\definecolor{scenarioclass}{RGB}{137, 197, 255}
...
\newcommand{\cbstartc}{\color{blue}}
\newcommand{\cbstartd}{\color{blue}}  % Changes since 2019 08 10
