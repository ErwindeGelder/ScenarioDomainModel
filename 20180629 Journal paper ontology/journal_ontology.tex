...
\author{Erwin de Gelder$^{1,2*}$, Jan-Pieter Paardekooper$^{1,3}$, Arash Khabbaz Saberi$^{1}$, Hala Elrofai$^{1}$, Olaf Op den Camp$^{1}$, \\ Jeroen Ploeg$^{4}$, Bart De Schutter$^{2}$%
...
\definecolor{scenarioclass}{RGB}{86, 172, 255}
\definecolor{category}{RGB}{64, 207, 255}
\definecolor{scenario}{RGB}{255, 115, 64}
\definecolor{otherclass}{RGB}{255, 159, 124}
...
\newcommand{\scenarioclass}{\mathcal{C}}
\newcommand{\scenarioclassa}{\scenarioclass_{1}}
\newcommand{\scenarioclassb}{\scenarioclass_{2}}
\newcommand{\scenarioclassc}{\scenarioclass_{3}}
\newcommand{\scenarioclassfallsinto}{\subseteq}
...
\newcommand{\cbstart}{\color{black}}
\newcommand{\cbend}{\color{black}}
\newcommand{\cbstartb}{\color{black}}
\newcommand{\cbstartc}{\color{black}}
