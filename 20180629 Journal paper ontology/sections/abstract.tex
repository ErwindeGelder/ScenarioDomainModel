\begin{abstract}
	...
	\cbstartc
	The development of assessment methods for the performance of Automated Vehicles (AVs) is essential to avoid blocking and delaying the deployment of AVs' technologies. 
	...
	Real-world scenario-based assessment is proposed among other approaches and widely supported by many players in the automotive field. In this approach test cases are derived from real-world scenarios that are obtained from real-world driving data.
	\cbend
