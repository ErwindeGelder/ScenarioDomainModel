\begin{abstract}
	...
	Real-world scenario-based assessment is proposed among other approaches and widely supported by many players in the automotive field. In this approach test cases are derived from real-world scenarios that are obtained from driving data.
	\cbend
