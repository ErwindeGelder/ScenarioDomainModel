...
We define acts as the combination of \cstartc dynamic physical things \cendc and the activities that are performed by the dynamic physical things or the combination of dynamic physical things and the activities they are subjected to.  %Additionally, the act can contain conditions that mark the start or end of the act.
