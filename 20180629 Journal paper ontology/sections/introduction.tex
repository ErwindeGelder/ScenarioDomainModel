...
% Our proposal
In this article, we propose \iac{oof} for the definition of scenarios \cendc\cstartd as a starting point for developing a full ontology of scenarios. 
...
% Outline
The outline of the article is as follows. In \cref{sec:background}, we explain why \cstartb \iac{oof} \cendb is useful and what the context is. 
