...
\cbstart
\subsubsection{An activity quantitatively describes the state of an actor}
...
An activity quantitatively a state and a state corresponds to an actor, e.g., the acceleration of a vehicle, and, therefore, an activity is performed by an actor. Note that the actor might be the ego vehicle. 
