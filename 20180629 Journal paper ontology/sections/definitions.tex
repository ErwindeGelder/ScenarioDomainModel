...
\begin{table}[t]
	...
	\begin{tabularx}{\linewidth}{lX}
		...
		Actor & Dynamic \cstarte physical thing \cende that has an intention \\
...
% "Requirements"
\cstarte As a basis for constructing a comprehensive definition for the concept of scenario, we list the major characteristics contained in the above definitions as follows:\cende
\begin{enumerate}
...
\cstartc When applying \cref{def:scenario} in an object-oriented framework, it is possible 
