...
\begin{itemize}
	...
	\item An ontology can be directly translated into a class structure for an object-oriented software implementation \cite{vanDamPhDThesis2009}. The ontology specifies the relationships between the different classes and provides information on the properties of a class and the possible values.
	...
	\item An ontology can be used as conceptual schemas in database systems \cite{gruber1993ontology}. A conceptual schema can be used to design a database structure.
\end{itemize}
