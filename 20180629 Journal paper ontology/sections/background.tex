...
The ultimate goal is to build a database with all relevant scenarios that \iac{av} has to cope with when driving in the real world \autocite{putz2017pegasus}. Hence, a scenario should be a description of a potential use case of \iac{av}. 
