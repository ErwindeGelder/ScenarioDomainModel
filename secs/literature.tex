...
%\cstartb \ac{drac} is calculated based on the assumption that the follower can avoid a potential collision by applying the required deceleration. 
%However, this assumption may not hold if the vehicle braking capability and the road conditions do not allow the driver to reach the required deceleration. \cendb 
