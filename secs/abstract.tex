...
% Our approach
We present a novel data-driven approach called the \ac{ourmethod} method. 
The \ac{ourmethod} method is used to derive \acp{ssm} that provide a probability that a certain specified event, such as a collision, happens in the near future. 
...
The \ac{ourmethod} method uses Monte Carlo simulations, such that the derived \acp{ssm} can accurately estimate the probability of the specified event.
