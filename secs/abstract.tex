...
As opposed to historical crash data, which takes a long time to obtain, \acp{ssm} can be used to determine the risk of a collision or harm real-time of a certain vehicle.
% Our approach
...
Our approach uses data to predict the possible variations of how the environment of the vehicle changes.
...
% Conclusions
Whereas the derived \ac{ssm} shows the potential of the approach, future work involves applying the approach for other types of traffic conflicts, such as lateral traffic conflicts or interactions wit vulnerable road users.
