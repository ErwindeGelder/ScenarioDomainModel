...
\end{equation}
In \autocite{degelder2021conditional}, algorithms are provided for sampling from \iac{kde} with a Gaussian kernel such that the resulting samples are subject to a linear constraint such as \cref{eq:linear constraint}.
