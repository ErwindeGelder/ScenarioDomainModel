...
The resulting dissimilarity measures using the length of the time series and the spline coefficients, as shown in \cref{tab:spline coefficients}, is shown in \cref{tab:dissimilarities}.
