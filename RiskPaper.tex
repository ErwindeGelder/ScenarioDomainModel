...
% Conclusion
Using our proposed method, we can compare safety criticality of various scenarios in an quantitative manner, which can be used as a safety metric for evaluating automated driving systems. 
