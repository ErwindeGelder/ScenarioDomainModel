...
\definecolor{colorDynBlock}{RGB}{170, 255, 124}
\definecolor{colorState}{RGB}{226, 255, 214}
\definecolor{colorStateBlock}{RGB}{154, 255, 100}
\definecolor{colorActivities}{RGB}{210, 255, 191}
\definecolor{colorActivitiesBlock}{RGB}{118, 255, 45}
\definecolor{colorActivitiesBlock2}{RGB}{87, 249, 0}
...
\tikzstyle{block}=[draw, text width=4.5em, align=center, block distance, minimum height=2.8em, text depth=1.1em]
...
\hspace{-8em} % For some strange reason, there is some white space on left side
\begin{tikzpicture}
	...
	\node[fill=colorDynBlock, block, left of=below scenario, node distance=0em](otherdyn){Other road user};
	\node[length dashed arrow, below of=otherdyn](otherdyn arrow){};
	\draw[dashed arrow] (otherdyn) -- (otherdyn arrow);
	\node[fill=colorDynBlock, block, left of=otherdyn](target){Target vehicle};
	...
	\node[fill=colorStateBlock, block, left of=below target, distance heading](heading){Heading};
	\node[fill=colorStateBlock, block, right of=below target, node distance=14em](speed){Speed};
	...
	\node[fill=colorActivitiesBlock, block, left of=lane following](left){Turn left};
	\node[fill=colorActivitiesBlock, block, right of=lane following](right){Turn right};
	...
	\node[fill=colorActivitiesBlock2, block, right of=lane change](other left){$\ldots$};
	...
	\node[fill=colorActivitiesBlock2, block, right of=emergency](other decelerating){$\ldots$};
