...
A scenario, for which the definition is proposed in \cref{sec:scenario definition}, consists of events. Events can be seen as the building blocks of a scenario. The notion of event is extensively used in literature \cite{breu1997towards, 
...
Whether it is regarding computing, %relativity,
