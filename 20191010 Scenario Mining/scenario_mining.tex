...
\newcommand{\timehorizon}{\time_{\mathrm{h}}}
\newcommand{\timedummy}{\tau}
\newcommand{\timeendinc}[1]{\time_{\mathrm{end}}^{+}\left(#1\right)}
\newcommand{\timeenddec}[1]{\time_{\mathrm{end}}^{-}\left(#1\right)}
\newcommand{\timeaccevent}{\time^{+}}
\newcommand{\timedecevent}{\time^{-}}
