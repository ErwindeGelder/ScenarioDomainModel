...
if __name__ == '__main__':
    ...
    compile_pr(31)
    compile_pr(32, usebiber=True)
    compile_pr(33, usebiber=True,
    ...
    compile_doc(join('20180629 Journal paper ontology', 'framework_scenarios_limited'),
                other=(join('20180629 Journal paper ontology', 'framework_scenarios'),
                       dict(usebiber=True)))
    compile_doc(join('20180629 Journal paper ontology', 'framework_scenarios'), usebiber=True)
    ...
    compile_doc(join('20200228 FISITA procudure paper', 'tagging_scenarios'), usebiber=True)
    compile_doc(join('20200318 FISITA categories paper', 'procedure'), usebiber=True)
