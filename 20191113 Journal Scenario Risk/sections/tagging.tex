...
\end{align}
\Cref{fig:explain symbols} illustrates how $\speedmin{\sample}$, $\speedmax{\sample}$, $\speedinc{\sample}$, and $\speeddec{\sample}$ are calculated.
...
\paragraph{Longitudinal activity of other vehicle}
...
\paragraph{Longitudinal state of other vehicle}
