...
2020 10 12: From now on, PhysicalElementCategory is not an abstract class.
"""

from .qualitative_element import QualitativeElement, _qualitative_thing_props_from_json
...
class PhysicalElementCategory(QualitativeElement):
    ...
    A PhysicalElementCategory is used to qualitatively describe a physical thing.
...
def _physical_thing_category_from_json(
    ...
    return PhysicalElementCategory(**_physical_thing_category_props_from_json(json))
