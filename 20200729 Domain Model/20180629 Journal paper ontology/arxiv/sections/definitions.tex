...
\begin{enumerate}
	...
	\item\textit{An event marks a mode transition or the moment a system reaches a threshold:}
...
\begin{enumerate}
	...
	\item\textit{An activity quantitatively describes the time evolution of a state \protect\cstart variable\protect\cend:}
