...
DOCUMENTS = [("actor_type", ("\\tree[\\node[tag] at (-15em, -0.8em) {Vehicle};" +
                             "\\draw[draw=black, line width=0.5mm] (-18.8em, -1.5em) " +
                             "rectangle (10.8em,-10.8em);]" +
             ...
             ("lon_activity", ("\\tree{Vehicle longitudinal activity}{Reversing; Standing still; " +
                               "Driving forward, Braking, Cruising, Accelerating}")),
             ...
             ("cyc_lon_activity", ("\\tree{Cyclist longitudinal activity}{Riding forward, " +
                                   ...
                                   "Standing still}")),
             ("initial_position", ("\\tree{Initial state}{Direction, Same as ego, Oncoming, " +
             ...
             ("road_layout", ("\\\tree{Road layout}{Straight, Merge, Entrance, Exit, Other; " +
                              ...
                              "No traffic light}")),
             ("static_object", ("\\tree{Static object}{On intended path, Passable, Impassable; " +
                                "View blocking; Other}")),
