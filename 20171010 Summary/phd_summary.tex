...
\begin{figure}[b]
	\begin{center}
		\tikzstyle{block}=[node distance=5em, text width=4.3em, minimum height=7em, align=center, rounded corners=8pt, font=\small]
		...
		\begin{tikzpicture}
			...
			\node[block, fill=green!30, right of=ed](p){\includegraphics[width=3em]{parametrisation.png} \\ Parame-trisation};
...
%In summary, the PhD research will focus on developing a methodology for the generation of real-life test cases for the assessment of automated vehicles using recorded driving data. This includes the ontology regarding and detection of events and scenarios. The events and scenarios need to be parametrised to enable the generation of new test cases. An important aspect of the research is to provide quantitative measures for the completeness of the data, the collected events, the collected scenarios and the generated test cases.
