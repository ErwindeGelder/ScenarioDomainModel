...
%% Document meta data
%%==========================================================================
\title[Ontology  | \insertsubtitle]{Streetwise}
\subtitle{TNO}
...
\begin{frame}
    ...
    \begin{tikzpicture}[overlay, remember picture]
	    ...
	    \node at (-3.3, 6) {\includegraphics[scale=0.6]{Streetwise.pdf}};
    \end{tikzpicture}
\end{frame}}
...
\begin{frame}{Introduction}
	\textbf{Question:}\\
	How does the Automated Vehicle operate in real-life traffic?\\
	\bigskip
